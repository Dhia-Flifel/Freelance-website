...
<body>
    <div class="topnav">
        <a href="Home.php"><img src="img/sitelogo.png" style="height: 85px;width:200px; margin-bottom:10px;margin-top:-15px;margin-right:20px;" ></a>
        <a href="#business" style="margin-top: 10px;">Bussines $</a>
        <a href="signup1.html" style="margin-left: 420px; margin-top: 10px;">Are You Freelencer?</a>
        <a href="signup2.html" style="margin-left: 40px;margin-top: 10px;">Are You  Hirer?</a>
        <a href="login.html" style="margin-left: 40px;margin-top: 10px;">Login</a>
    </div>
    <div id="stars"></div>
    <div id="stars2"></div>
    <div id="stars3"></div>
    <div class="row">
        ...
        <div class="col">
            <div class="search">
                ...
                <form>
                    <div class="row">
                        <input class="form-control mx-2" id="search1" style="width: 300px;" type="search" placeholder="Try: Web Designer..." aria-label="Search" autofocus>
                        <button class="btn btn-outline-info" style="width: 100px;" type="submit">Search</button>
                    </div>
                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide " data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item">
                            <img src="img/2.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/3.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/4.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/5.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/6.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/7.png" class="d-block w-80" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/8.png" class="d-block w-80" alt="...">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="cat">
        <div class="alert alert-secondary" role="alert">
            ...
            <h2 style="color: black;margin-bottom:50px;">Categorie:</h2>

            <div class="row">

                <div class="col">
                    <a href="#"><img src="img/logo3.png" style="width: 100px; height: 100px;">

                        <h4 style="color: black;"><b>Programing</b></h4>
                    </a>
                </div>

                <div class="col">
                    <a href="#"><img src="img/logo6.png" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Data</b></h4>
                    </a>
                </div>

                <div class="col">
                    <a href="#"><img src="img/logo5.png" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Graphics & Designer</b></h4>
                    </a>
                </div>


                <div class="col">
                    <a href="#"><img src="img/logo8.gif" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Audio & Video</b></h4>
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col" style="margin-top: 80px;">
                    <a href="#"><img src="img/logo2.png" style="width: 100px; height: 100px;color: white;">
                        <h4 style="color: black;"><b>Software Testing</b></h4>
                    </a>
                </div>
                <div class="col" style="margin-top: 80px;">
                    <a href="#"><img src="img/logo4.png" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Blockchain Developer</b></h4>
                    </a>
                </div>
                <div class="col" style="margin-top: 80px;">
                    <a href="#"><img src="img/logo7.png" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Gamings</b></h4>
                    </a>
                </div>
                <div class="col" style="margin-top: 80px;">
                    <a href="#"><img src="img/logo1.png" style="width: 100px; height: 100px;">
                        <h4 style="color: black;"><b>Marketing</b></h4>
                    </a>
                </div>
            </div>
        </div>
...
$link = mysqli_connect("localhost", "root", "", "freelace_db");
...
if($result = mysqli_query($link, $sql)){
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
           ...
           echo  '   <p class="card-text">' . $row['projectabout'] . '</p>';
           echo  '   <a href="#" class="card-link">Work Detail</a> ';
           echo  '   </div> ';
           echo  '   </div> ';
...
?>
    ...
    <nav style="background-color: silver;margin-top:40%">
    <center>
        <h4 style="color:black; font-weight: bold;">www.TheFreelances.com </h3>
        <h5 style="color:black;">Copyright DHF</h5>
        <h5 style="color:black;">All Right Reserved</h5>  

        <a href="https://www.facebook.com/profile.php?id=100010138274992" class="fa fa-facebook"></a>
        <a href="https://www.youtube.com/channel/UC2JXznP_tAJN7-NTG_2nBXg" class="fa fa-youtube"></a>
        <a href="https://www.linkedin.com/in/dhia-flifel-3551aa173/" class="fa fa-linkedin"></a>
    </center>
</nav>
</body>
